"""Wire layer: HTTP/SSE transport, retry, usage accounting, request logging.

Depends only on config (safeprint, _CORE_DIR) — no codec/session imports; the
parse function is injected into _stream_with_retry by the caller.
"""
import os, re, time, requests
from datetime import datetime
from .config import safeprint, _CORE_DIR
print = safeprint
